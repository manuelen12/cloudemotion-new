                            ...
                            <div class="qodef-position-right-inner">
                                <nav class="qodef-main-menu qodef-drop-down qodef-default-nav">
                                    <ul id="menu-main-menu" class="clearfix">
                                        ...
                                        <li id="nav-menu-item-632" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub wide icons wide_background">
                                            <a href="#blogs" parallax-cl class="">
                                                <span class="item_outer">
                                                    <span class="item_inner">
                                                        <span class="menu_icon_wrapper">
                                                            <i class="menu_icon null fa"></i>
                ...
                <div class="qodef-content-inner">
                    <div class="qodef-full-width">
                        <div class="qodef-full-width-inner">
                            ...
                            <div class="vc_row wpb_row vc_row-fluid qodef-section vc_custom_1462539692373 qodef-content-aligment-center qodef-grid-section" id="workWithUs">
                                                                        ...
                                                                        <div class="qodef-fullwidth-slider-item-wrapper-inner">
                                                                            <div class="qodef-fullwidth-slider-item-elements-holder">
                                                                                <div class="qodef-fullwidth-slider-item-title">
                                                                                    <h2>¿Quieres Iniciar Tu Proyecto Digital?</h2>
                                                                                </div>
                                                                                <div class="qodef-fullwidth-slider-item-subtitle">
                                                                                    <h4>En Cloudemotion nos preocupamos estamos preparados para atender cualquier solucion Tecnologica </h4>
                                                                                </div>
                                                                                <div class="qodef-fullwidth-slider-item-text">
                                                                                    <p><strong>Porque nuestras Prioridades son las tuyas...</strong> </p>
                                                                                </div>
                                                                ...
                                                                <div class="qodef-fullwidth-slider-item-content-wrapper">
                                                                    <div class="qodef-fullwidth-slider-item-wrapper-inner">
                                                                        <div class="qodef-fullwidth-slider-item-elements-holder">
                                                                            ...
                                                                            <div class="qodef-fullwidth-slider-item-text">
                                                                                <p align="justify">Usamos las más modernas y ágiles metodologías como <strong>SCRUM</strong> e <strong>Increasing Marketing</strong> para la administración de proyectos tecnológicos de cualquier tamaño. Ahorrate los dolores de cabeza, costos de personal y pérdida de tiempo que puede implicar la gestión de proyectos dejalo en manos de nuestro equipo que garantizaremos tu éxito</p>
                                                                            </div>
                                                                            <div class="qodef-fullwidth-slider-item-button">
                                                                                <a href="#" target="_self"  class="qodef-btn qodef-btn-medium qodef-btn-solid qodef-btn-icon"  >
                                                                ...
                                                                <div class="qodef-fullwidth-slider-item-content-wrapper">
                                                                    <div class="qodef-fullwidth-slider-item-wrapper-inner">
                                                                        <div class="qodef-fullwidth-slider-item-elements-holder">
                                                                            ...
                                                                            <div class="qodef-fullwidth-slider-item-text">
                                                                                <p align="justify">Si estás buscando un servicio que te permita crear o potenciar la Marca de tu empresa aplicando las más modernas tecnologías digitales, has llegado al sitio adecuado. El equipo <strong>Cloudemotion</strong> emplea para ello técnicas de <strong>SEO</strong>,<strong> SMO</strong>, <strong>SEM</strong>, <strong>SMM</strong>, <strong>PPC</strong>, además de gestión de redes sociales, diseño de infografías y estrategias de email Marketing que permitirán generar contenidos atractivos que capten completamente la atención de los usuarios.</p>
                                                                            </div>
                                                                            <div class="qodef-fullwidth-slider-item-button">
                                                                                <a href="#" target="_self"  class="qodef-btn qodef-btn-medium qodef-btn-solid qodef-btn-icon"  >
                        ...
                        <div class="vc_row wpb_row vc_row-fluid qodef-section vc_custom_1445420473166 qodef-content-aligment-left qodef-grid-section" id="teamWork" >
                            <div class="clearfix qodef-section-inner">
                                <div class="qodef-section-inner-margin clearfix">
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner ">
                        ...
                        <div class="vc_row wpb_row vc_row-fluid qodef-section qodef-content-aligment-left" id="portfolios">
                            <div class="clearfix qodef-full-section-inner">
                                <div class="wpb_column vc_column_container vc_col-sm-12">
                                    <div class="vc_column-inner ">
                                        <div class="wpb_wrapper">
                                                ...
                                                <div class = "qodef-portfolio-list-holder clearfix" >
                                                    <article class="qodef-portfolio-item mix portfolio_category_10 portfolio_category_7" >
                                                        ...
                                                        <div class = "qodef-item-image-holder">
                                                            ...
                                                            <img width="800" height="600" src="./wp-content/themes/cloudemotion/assets/img/p-office-management-systems-800x600.jpg" class="attachment-qode_startit_landscape size-qode_startit_landscape wp-post-image" />
                                                        </div>
                                ...
                                <div class="wpb_column vc_column_container vc_col-sm-12">
                                    <div class="vc_column-inner ">
                                        <div class="wpb_wrapper">
                                            <div class="wpb_text_column wpb_content_element ">
                                                <div class="wpb_wrapper">
                                                    <h2>Conoce a los profesionales detras de tus proyectos</h2>
                                                </div>
                                            </div>
                                            <div class="vc_empty_space"  style="height: 22px" >
                                                <span class="vc_empty_space_inner"></span>
                                            ...
                                            <div class="wpb_text_column wpb_content_element ">
                                                <div class="wpb_wrapper">
                                                    <h4>Dale un vistazo y certifica los conocimientos de nuestros desarrolladores</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="clearfix qodef-full-section-inner">
                                <div class="wpb_column vc_column_container vc_col-sm-12">
                                    <div class="vc_column-inner vc_custom_1445413182400">
                                        <div class="wpb_wrapper">
                                            <span class="qodef-icon-shortcode circle" style="width: 102px;height: 102px;line-height: 102px;background-color: #25cbf5;border-style: solid;border-width: 0px" data-hover-background-color="#25cbf5" data-hover-color="#ffffff" data-color="#ffffff">
                                                    ...
                                                    <div class="qodef-elements-holder-item-inner">
                                                        <div class="qodef-elements-holder-item-content qodef-elements-holder-custom-523022" style="padding: 63px 120px 58px 80px">
                                                            ...
                                                            <div class="wpb_text_column wpb_content_element ">
                                                                <div class="wpb_wrapper">
                                                                    <h3>
                                                                        <span style="color: #ffffff;">Porque apostar por NodeJS</span>
                                                                    </h3>
                                                                </div>
                                                            </div>
                                                            <div class="vc_empty_space"  style="height: 18px" >
                                                ...
                                                <div class="qodef-elements-holder-item qodef-vertical-alignment-middle qodef-horizontal-alignment-left" style="background-image: url(./wp-content/themes/cloudemotion/assets/img/cover-box-2-home-main.png)">
                                                    <div class="qodef-elements-holder-item-inner">
                                                        <div class="qodef-elements-holder-item-content qodef-elements-holder-custom-767784" style="padding: 63px 120px 58px 80px">
                                                            ...
                                                            <div class="wpb_text_column wpb_content_element ">
                                                                <div class="wpb_wrapper">
                                                                    <h3>Django: FrameWork de alto nivel!</h3>
                                                                </div>
                                                            </div>
                                                            <div class="vc_empty_space"  style="height: 18px" >
                                                                <span class="vc_empty_space_inner"></span>
                                                            ...
                                                            <div class="qodef-custom-font-holder" style="font-family: Raleway;font-size: 15px;line-height: 23px;font-weight: 400;color: #797979" data-font-size= 15 data-line-height= 23>
                                                                ...
                                                                Los desarrolladores de Django lo definen así: “Django es un framework web de alto nivel que fomenta el desarrollo rápido y el diseño limpio y pragmático”, algo muy prometedor, pero  ¿Cuán cierta es esta definición?
                                                            </div>
                                                            <div class="vc_empty_space"  style="height: 60px" >
                                                                <span class="vc_empty_space_inner"></span>
                                                            </div>
                                                    ...
                                                    <div class="qodef-elements-holder-item-inner">
                                                        <div class="qodef-elements-holder-item-content qodef-elements-holder-custom-866678" style="padding: 63px 120px 58px 80px">
                                                            ...
                                                            <div class="wpb_text_column wpb_content_element ">
                                                                <div class="wpb_wrapper">
                                                                    <h3>
                                                                        <span style="color: #ffffff;">Aplicaciones moviles - Phonegap(Hibrida) vs React Native(Bridge) vs Android/IOS(Nativas)</span>
                                                                    </h3>
                                                                </div>
                                                            </div>
                                                            <div class="vc_empty_space"  style="height: 18px" >
                                                            ...
                                                            <div class="qodef-custom-font-holder" style="font-family: Raleway;font-size: 15px;line-height: 23px;font-weight: 400;color: #ffffff" data-font-size= 15 data-line-height= 23>
                                                                Cada vez surguen mas tecnologias para poder cubrir la demanda de una de las plataformas mas utilizadas a nivel mundial(Movil) pero a medida que estas se fortalecen y mejoran sus debilidades no podemos evitar hacernos la pregunta de <strong>¿Que tecnologia es la adecuada para mis proyectos?</strong> y lo cierto es que todas pueden llegar a cumplir tus espectativas.. pero, cual se acopla mas a ti? Cloudemotion Tiene la respuesta a tu pregunta
                                                            </div>
                                                            <div class="vc_empty_space"  style="height: 60px" >
                                                                <span class="vc_empty_space_inner"></span>
                                                            </div>
