                                        ...
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                                            <h2 style="text-align: center;">En la Union esta la Fuerza</h2>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                                            <h4 style="text-align: center;">La Planificacion de Proyectos, El Desarrollo del mismo y el Marketing no son puntos a tratar por separado...</h4>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    ...
                                                    <div class="wpb_text_column wpb_content_element  vc_custom_1446567667184">
                                                        <div class="wpb_wrapper">
                                                            <h2>La Planificacion lo es Todo...</h2>
                                                        </div>
                                                    </div>
                                                    <div class="vc_empty_space"  style="height: 18px" >
                                                        <span class="vc_empty_space_inner"></span>
                                                    ...
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                                            <h4>Siempre contempla todos tus requerimientos y trata de gestionarlos en un documento, discutelos con tu personal y planifica un modelo por el cual te sientas comodo y puedas transmitir tus ideas. haciendo que tu proyecto sea exitoso desde el inicio</h4>
                                                            <br>
                                                                ...
                                                                <div class="vc_column-inner ">
                                                                    <div class="wpb_wrapper">
                                                                        ...
                                                                        <div class="qodef-icon-list-item">
                                                                            ...
                                                                            <p class="qodef-icon-list-text"  >Estas soluciones tienen debilidades</p>
                                                                        </div>
                                                                        <div class="qodef-icon-list-item">
                                                                            <div class="qodef-icon-list-icon-holder">
                                                                                <div class="qodef-icon-list-icon-holder-inner clearfix">
                                                                ...
                                                                <div class="vc_column-inner ">
                                                                    <div class="wpb_wrapper">
                                                                        ...
                                                                        <div class="qodef-icon-list-item">
                                                                            ...
                                                                            <p class="qodef-icon-list-text">¿Tienes algun bosquejo de como quieres que lusca esta solucion?</p>
                                                                        </div>
                                                                        <div class="qodef-icon-list-item">
                                                                            <div class="qodef-icon-list-icon-holder">
                                                                                <div class="qodef-icon-list-icon-holder-inner clearfix">
