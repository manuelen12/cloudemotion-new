function initAnimation(window.theme, jQuery) {
...
// Masonry
function initMasonry(window.theme,jQuery) {
	// body...
	theme = theme || {};
...
// Match Height
function initMatch(window.theme,jQuery) {
...
// Parallax
function initParallax(window.theme,jQuery) {
	// body...
	theme = theme || {};
...
// Progress Bar
function initProgressBar(window.theme,jQuery) {
...
// Scroll to Top
function initScrollTop(window.theme,jQuery) {
	// body...
	theme = theme || {};
...
function initSort(window.theme,jQuery) {
	// body...
	theme = theme || {};
...
// Validation
function initValidation(window.theme,jQuery) {
	// body...
	theme = theme || {};
...
// Nav
function initNav(window.theme,jQuery) {
	// body...
