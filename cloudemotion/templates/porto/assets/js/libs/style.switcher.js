...
var styleSwitcher = {
    ...
    initialize: function() {
        var a = this,
            ...
            d = $("head"),
            e = $("#styleSwitcherScript").data("skin-src") ? $("#styleSwitcherScript").data("skin-src") : c + "master/less/skin-default.less";
        if (a.basePath = c, !this.initialized) {
            ...
            d.append($('<link rel="stylesheet/less">').attr("href", e)), d.append($('<link rel="stylesheet">').attr("href", c + "./assets/css/libscss/bootstrap-colorpicker.css")), $.styleSwitcherCachedScript(c + "./assets/js/libs/bootstrap-colorpicker.min.js").done(function(d, e) {
                ...
                }, $.styleSwitcherCachedScript(c + "./assets/js/less.js").done(function(d, e) {
                    $.ajax({
                        url: c + "master/style-switcher/style.switcher.html"
                    }).done(function(c) {
    ...
    initializeSimpleMode: function() {
        ...
        $("body").append(d), "img/logo.png" == c && a.setLogo(), $("#styleSwitcherSimpleOpen").on("click", function(d) {
            d.preventDefault(), b.attr("src", c), $(this).find(".fa").removeClass().addClass("fa fa-cog fa-spin fa-fw"), $.cookie("showSwitcher", !0), a.initialized = !1, a.initialize()
        })
    },
    build: function() {
        var a = this,
    ...
    setLayoutStyle: function(a, b) {
        ...
        d.find(".active").removeClass("active"), d.find("a[data-layout-type=" + a + "]").addClass("active"), "wide" == a ? (e.hide(), $("html").removeClass("boxed"), $.removeCookie("backgroundPattern")) : (e.show(), $("html").addClass("boxed"), null == $.cookie("backgroundPattern") && this.container.find("ul[data-type=patterns] li:first a").trigger("click")), $.event.trigger({
    ...
    setBackgroundPattern: function(a) {
        ...
        c && $("html").css("background-image", "url(img/patterns/" + a + ".png)"), b.options.preserveCookies || $.cookie("backgroundPattern", a), $.event.trigger({
